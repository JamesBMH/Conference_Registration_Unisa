...
public:
    ...
    // Overloaded constructor to allow the specification of booking dates
    explicit GuestRegistration(Person a, QString q, QString booking, QObject *parent = nullptr);
